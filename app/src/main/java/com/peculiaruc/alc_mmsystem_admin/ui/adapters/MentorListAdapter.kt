...
class MentorListAdapter(private val mentorClickListener: (Mentor) -> Unit) :
    ListAdapter<Mentor, MentorListAdapter.MentorListViewHolder>(DiffCallback) {
    companion object {
     ...
     */
    class MentorListViewHolder(private var binding: ItemMentorBinding) :
